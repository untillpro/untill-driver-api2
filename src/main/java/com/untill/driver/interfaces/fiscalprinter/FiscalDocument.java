...
public class FiscalDocument {
	...
	/**
	 * Reopened document ID, this ID is generated by fiscal device and present only for already fiscalized document
	 */
	private String reopenedDocumentId;
	...
	public String getReopenedDocumentId() {
		return reopenedDocumentId;
	}

	public void setReopenedDocumentId(String reopenedDocumentId) {
		this.reopenedDocumentId = reopenedDocumentId;
	}
